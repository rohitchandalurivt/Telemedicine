...
// The @Entity annotation designates this class as a JPA Entity class representing the User table in the TeleMEDB database.
@Entity
...
public class User implements Serializable {
    ...
    of the User table in the TeleMEDB database.
    ======================================================
     */
