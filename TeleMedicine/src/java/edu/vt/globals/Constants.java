...
public final class Constants {
    ...
    public static final String PHOTOS_ABSOLUTE_PATH = "C:/Users/Balci/DocRoot/TeleMedicine/";
    
    macOS (Unix or Linux): Specify the absolute directory path as shown below.
     */
    
     public static final String FILES_ABSOLUTE_PATH  = "/Users/riteshbansal/DocRoot/CloudStorage/FileStorage/";
    public static final String PHOTOS_ABSOLUTE_PATH = "/Users/riteshbansal/DocRoot/CloudStorage/PhotoStorage/";
    //public static final String FILES_ABSOLUTE_PATH  = "/home/cloudsd/Chandaluri/DocRoot/TeleMedicine/FileStorage/";
    //public static final String PHOTOS_ABSOLUTE_PATH = "/home/cloudsd/Chandaluri/DocRoot/TeleMedicine/PhotoStorage/";
    ...
    *       implies that you can put directories and files within the /CloudStorage/ top directory.
    ...
    tag <h> automatically inserts the app name, e.g., /TeleMedicine, before the relative path.
    Then, for example, when
    
        /TeleMedicine/TeleMedicine/PhotoStorage/defaultUserPhoto.png
    
    is processed by GlassFish, GlassFish knows because of the glassfish-web.xml file that the
    DocRoot is "/Users/Balci/DocRoot" for the app named TeleMedicine and replaces the app name with
    DocRoot to obtain the absolute path to the file, 
    
        /Users/Balci/DocRoot/TeleMedicine/PhotoStorage/defaultUserPhoto.png
    ...
    #{facesContext.externalContext.requestContextPath} returns 
        <> the app name starting with slash, e.g., /TeleMedicine, if an external file is referenced or
        <> the URI of the Web Pages folder of the application if an internal file is referenced.
     */

    public static final String FILES_RELATIVE_PATH = "/TeleMedicine/FileStorage/";
    public static final String PHOTOS_RELATIVE_PATH = "/TeleMedicine/PhotoStorage/";
    public static final String DEFAULT_PHOTO_RELATIVE_PATH = "/TeleMedicine/PhotoStorage/defaultUserPhoto.png";
