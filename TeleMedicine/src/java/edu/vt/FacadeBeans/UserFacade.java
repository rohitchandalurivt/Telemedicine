...
public class UserFacade extends AbstractFacade<User> {
        ...
        /*
    ------------------------------------------------------------------------------------------------------
    Annotating 'private EntityManager em;' with '@PersistenceContext(unitName = "TeleMedicinePU")' 
    implies that the EntityManager instance pointed to by 'em' is associated with the 'TeleMedicinePU'
