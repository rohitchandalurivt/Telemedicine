 ...
 * @author Rohit
 */
// The @Entity annotation designates this class as a JPA Entity class representing the UserPhoto table in the TeleMeDB database.
@Entity
...
public class UserPhoto implements Serializable {
    ...
    of the UserPhoto table in the TeleMeDB database.
    ========================================================
     */
    ...
    represent a row in the UserPhoto table in the TeleMeDB database.
    =================================================================
     */
    public UserPhoto() {
    }
